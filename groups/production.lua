...
util.regroup.set_subgroup_to_prototype("fu_miner_item", "production-stone-crusher", "01")
util.regroup.set_subgroup_to_prototype("fu_miner_recipe_2", "production-stone-crusher", "02")
util.regroup.set_subgroup_to_prototype("fu_miner_item_2", "production-stone-crusher", "02")
util.regroup.set_subgroup_to_prototype("fu_miner_recipe_3", "production-stone-crusher", "03")
util.regroup.set_subgroup_to_prototype("fu_miner_item_3", "production-stone-crusher", "03")
util.regroup.set_subgroup_to_prototype("fu_miner_recipe_4", "production-stone-crusher", "04")
util.regroup.set_subgroup_to_prototype("fu_miner_item_4", "production-stone-crusher", "04")
...
util.regroup.set_subgroup_to_prototype("el_burner_item", "production-248k-el", "01")
util.regroup.set_subgroup_to_prototype("el_burner_kerosene_recipe", "production-248k-el", "02")
util.regroup.set_subgroup_to_prototype("el_burner_kerosene_item", "production-248k-el", "02")
util.regroup.set_subgroup_to_prototype("fu_burner_recipe", "production-248k-el", "03")
util.regroup.set_subgroup_to_prototype("fu_burner_item", "production-248k-el", "03")
util.regroup.set_subgroup_to_prototype("el_pressurizer_recipe", "production-248k-el", "04")
util.regroup.set_subgroup_to_prototype("el_pressurizer_item", "production-248k-el", "04")
util.regroup.set_subgroup_to_prototype("el_water_generator_recipe", "production-248k-el", "05")
util.regroup.set_subgroup_to_prototype("el_water_generator_item", "production-248k-el", "05")
util.regroup.set_subgroup_to_prototype("el_grower_recipe", "production-248k-el", "06")
util.regroup.set_subgroup_to_prototype("el_grower_item", "production-248k-el", "06")
util.regroup.set_subgroup_to_prototype("el_charger_recipe", "production-248k-el", "07")
util.regroup.set_subgroup_to_prototype("el_charger_item", "production-248k-el", "07")
util.regroup.set_subgroup_to_prototype("el_purifier_recipe", "production-248k-el", "08")
util.regroup.set_subgroup_to_prototype("el_purifier_item", "production-248k-el", "08")
util.regroup.set_subgroup_to_prototype("el_arc_furnace_recipe", "production-248k-el", "09")
util.regroup.set_subgroup_to_prototype("el_arc_furnace_item", "production-248k-el", "09")
util.regroup.set_subgroup_to_prototype("el_caster_recipe", "production-248k-el", "10")
util.regroup.set_subgroup_to_prototype("el_caster_item", "production-248k-el", "10")

-- production-248k-fi
util.regroup.set_subgroup_to_prototype("fi_castor_recipe", "production-248k-fi", "01")
util.regroup.set_subgroup_to_prototype("fi_castor_item", "production-248k-fi", "01")
util.regroup.set_subgroup_to_prototype("fi_fiberer_recipe", "production-248k-fi", "02")
util.regroup.set_subgroup_to_prototype("fi_fiberer_item", "production-248k-fi", "02")
util.regroup.set_subgroup_to_prototype("fi_compound_machine_recipe", "production-248k-fi", "03")
util.regroup.set_subgroup_to_prototype("fi_compound_machine_item", "production-248k-fi", "03")
util.regroup.set_subgroup_to_prototype("fi_crusher_recipe", "production-248k-fi", "04")
util.regroup.set_subgroup_to_prototype("fi_crusher_item", "production-248k-fi", "04")

-- production-248k-fu
util.regroup.set_subgroup_to_prototype("fu_activator_recipe", "production-248k-fu", "01")
util.regroup.set_subgroup_to_prototype("fu_activator_item", "production-248k-fu", "01")
util.regroup.set_subgroup_to_prototype("fu_fusor_recipe", "production-248k-fu", "02")
util.regroup.set_subgroup_to_prototype("fu_fusor_item", "production-248k-fu", "02")
util.regroup.set_subgroup_to_prototype("fu_ingot_recipe", "production-248k-fu", "03")
util.regroup.set_subgroup_to_prototype("fu_ingot_item", "production-248k-fu", "03")
util.regroup.set_subgroup_to_prototype("fu_laser_recipe", "production-248k-fu", "04")
util.regroup.set_subgroup_to_prototype("fu_laser_item", "production-248k-fu", "04")
util.regroup.set_subgroup_to_prototype("fu_magnet_recipe", "production-248k-fu", "05")
util.regroup.set_subgroup_to_prototype("fu_magnet_item", "production-248k-fu", "05")
util.regroup.set_subgroup_to_prototype("fu_plasma_recipe", "production-248k-fu", "06")
util.regroup.set_subgroup_to_prototype("fu_plasma_item", "production-248k-fu", "06")
util.regroup.set_subgroup_to_prototype("fu_turbine_recipe", "production-248k-fu", "07")
util.regroup.set_subgroup_to_prototype("fu_turbine_item", "production-248k-fu", "07")
util.regroup.set_subgroup_to_prototype("fu_boiler_recipe", "production-248k-fu", "08")
util.regroup.set_subgroup_to_prototype("fu_boiler_item", "production-248k-fu", "08")
util.regroup.set_subgroup_to_prototype("fu_exchanger_recipe", "production-248k-fu", "09")
util.regroup.set_subgroup_to_prototype("fu_exchanger_item", "production-248k-fu", "09")
...
util.regroup.set_subgroup_to_prototype("fu_star_engine_core_item", "production-248k-fu-star-engine", "01")
util.regroup.set_subgroup_to_prototype("fu_star_engine_cooler_up_recipe", "production-248k-fu-star-engine", "02")
util.regroup.set_subgroup_to_prototype("fu_star_engine_cooler_up_item", "production-248k-fu-star-engine", "02")
util.regroup.set_subgroup_to_prototype("fu_star_engine_cooler_recipe", "production-248k-fu-star-engine", "03")
util.regroup.set_subgroup_to_prototype("fu_star_engine_cooler_item", "production-248k-fu-star-engine", "03")
util.regroup.set_subgroup_to_prototype("fu_star_engine_heater_left_recipe", "production-248k-fu-star-engine", "04")
util.regroup.set_subgroup_to_prototype("fu_star_engine_heater_left_item", "production-248k-fu-star-engine", "04")
util.regroup.set_subgroup_to_prototype("fu_star_engine_heater_recipe", "production-248k-fu-star-engine", "05")
util.regroup.set_subgroup_to_prototype("fu_star_engine_heater_item", "production-248k-fu-star-engine", "05")
