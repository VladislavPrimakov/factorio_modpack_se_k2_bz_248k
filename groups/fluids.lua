...
util.regroup.create_subgroup("fluids-chloride", "fluids", "raw-04")
util.regroup.create_subgroup("fluids-nitrogen", "fluids", "raw-05")
util.regroup.create_subgroup("fluids-sulfuric", "fluids", "raw-06")
util.regroup.create_subgroup("fluids-other", "fluids", "raw-07")
util.regroup.create_subgroup("fluids-thermofluid", "fluids", "raw-08")
util.regroup.create_subgroup("fluids-stream", "fluids", "raw-09")
util.regroup.create_subgroup("fluids-gel", "fluids", "raw-10")
util.regroup.create_subgroup("fluids-metals", "fluids", "raw-11")
util.regroup.create_subgroup("fluids-248k", "fluids", "raw-12")
util.regroup.create_subgroup("fluids-248k-metals", "fluids", "raw-12")
util.regroup.create_subgroup("fluids-248k-atom", "fluids", "raw-12")
util.regroup.create_subgroup("fluids-248k-atom-metals", "fluids", "raw-13")
util.regroup.create_subgroup("fluids-beacon", "fluids", "raw-14")
...
util.regroup.set_subgroup_to_prototype("se-space-water", "fluids-water", "07", "fluid")
util.regroup.set_subgroup_to_prototype("se-contaminated-space-water", "fluids-water", "08", "fluid")
util.regroup.set_subgroup_to_prototype("heavy-water", "fluids-water", "09", "fluid")
...
-- fluids-other
util.regroup.set_subgroup_to_prototype("oxygen", "fluids-other", "01", "fluid")
util.regroup.set_subgroup_to_prototype("formaldehyde", "fluids-other", "02", "fluid")
util.regroup.set_subgroup_to_prototype("biomethanol", "fluids-other", "03", "fluid")
util.regroup.set_subgroup_to_prototype("hydrogen", "fluids-other", "04", "fluid")
util.regroup.set_subgroup_to_prototype("gas", "fluids-other", "05", "fluid")
util.regroup.set_subgroup_to_prototype("se-methane-gas", "fluids-other", "06", "fluid")
util.regroup.set_subgroup_to_prototype("bi-biomass", "fluids-other", "07", "fluid")
util.regroup.set_subgroup_to_prototype("se-bio-sludge", "fluids-other", "08", "fluid")
util.regroup.set_subgroup_to_prototype("se-contaminated-bio-sludge", "fluids-other", "09", "fluid")
util.regroup.set_subgroup_to_prototype("se-liquid-rocket-fuel", "fluids-other", "10", "fluid")
...
-- fluids-248k-atom
util.regroup.set_subgroup_to_prototype("fu_protium", "fluids-248k-atom", "01", "fluid")
util.regroup.set_subgroup_to_prototype("fu_protium_heated", "fluids-248k-atom", "02", "fluid")
...
util.regroup.set_subgroup_to_prototype("fu_lithium_7", "fluids-248k-atom", "08", "fluid")
util.regroup.set_subgroup_to_prototype("fu_lithium_7_heated", "fluids-248k-atom", "09", "fluid")
util.regroup.set_subgroup_to_prototype("fu_lithium_6", "fluids-248k-atom", "10", "fluid")
util.regroup.set_subgroup_to_prototype("fu_neutron_fluid", "fluids-248k-atom", "11", "fluid")
util.regroup.set_subgroup_to_prototype("fu_hydrogen", "fluids-248k-atom", "12", "fluid")
util.regroup.set_subgroup_to_prototype("fu_oxygen", "fluids-248k-atom", "13", "fluid")

-- fluids-248k-atom-metals
util.regroup.set_subgroup_to_prototype("fu_sulfur", "fluids-248k-atom-metals", "01", "fluid")
util.regroup.set_subgroup_to_prototype("fu_sulfur_heated", "fluids-248k-atom-metals", "02", "fluid")
util.regroup.set_subgroup_to_prototype("fu_sulfur", "fluids-248k-atom-metals", "03", "fluid")
util.regroup.set_subgroup_to_prototype("fu_iron", "fluids-248k-atom-metals", "04", "fluid")
util.regroup.set_subgroup_to_prototype("fu_iron_heated", "fluids-248k-atom-metals", "05", "fluid")
util.regroup.set_subgroup_to_prototype("248k-nickel-atom", "fluids-248k-atom-metals", "06", "fluid")
util.regroup.set_subgroup_to_prototype("248k-nickel-atom-hot", "fluids-248k-atom-metals", "07", "fluid")
util.regroup.set_subgroup_to_prototype("fu_copper", "fluids-248k-atom-metals", "08", "fluid")
util.regroup.set_subgroup_to_prototype("fu_copper_heated", "fluids-248k-atom-metals", "09", "fluid")
util.regroup.set_subgroup_to_prototype("fu_copper", "fluids-248k-atom-metals", "10", "fluid")
util.regroup.set_subgroup_to_prototype("248k-zinc-atom", "fluids-248k-atom-metals", "11", "fluid")
util.regroup.set_subgroup_to_prototype("248k-zinc-atom-hot", "fluids-248k-atom-metals", "12", "fluid")
util.regroup.set_subgroup_to_prototype("fu_uranium_235", "fluids-248k-atom-metals", "13", "fluid")
util.regroup.set_subgroup_to_prototype("fu_uranium_235_heated", "fluids-248k-atom-metals", "14", "fluid")
util.regroup.set_subgroup_to_prototype("fu_uranium_238", "fluids-248k-atom-metals", "15", "fluid")
util.regroup.set_subgroup_to_prototype("fu_uranium_238_heated", "fluids-248k-atom-metals", "16", "fluid")
