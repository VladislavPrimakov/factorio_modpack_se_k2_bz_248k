...
util.regroup.create_subgroup("space-intermediate-product-spaceship-structure", "space-intermediate-products", "raw-01")
util.regroup.create_subgroup("space-intermediate-product-satellite", "space-intermediate-products", "raw-02")
util.regroup.create_subgroup("space-intermediate-product-specialist-assembling", "space-intermediate-products", "raw-03")
util.regroup.create_subgroup("space-intermediate-product-observation-frame", "space-intermediate-products", "raw-04")
util.regroup.create_subgroup("space-intermediate-product-thermofluid", "space-intermediate-products", "raw-05")
util.regroup.create_subgroup("space-intermediate-product-specimen", "space-intermediate-products", "raw-06")
util.regroup.create_subgroup("space-intermediate-product-arcosphere", "space-intermediate-products", "raw-07")
util.regroup.create_subgroup("space-intermediate-product-arcosphere-folding", "space-intermediate-products", "raw-08")
util.regroup.create_subgroup("space-intermediate-product-canister-fill", "space-intermediate-products", "raw-09")
util.regroup.create_subgroup("space-intermediate-product-stream", "space-intermediate-products", "raw-10")
util.regroup.create_subgroup("space-intermediate-product-gel", "space-intermediate-products", "raw-11")
util.regroup.create_subgroup("space-intermediate-product-sludge", "space-intermediate-products", "raw-12")
util.regroup.create_subgroup("space-intermediate-product-particle-stream", "space-intermediate-products", "raw-13")
util.regroup.create_subgroup("space-intermediate-product-materialisation", "space-intermediate-products", "raw-14")
util.regroup.create_subgroup("basic-matter-conversion", "space-intermediate-products", "raw-15")
util.regroup.create_subgroup("matter-conversion", "space-intermediate-products", "raw-16")

-- space-intermediate-product-spaceship-structure
util.regroup.set_subgroup_to_prototype("se-spaceship-console", "space-intermediate-product-spaceship-structure", "01")
util.regroup.set_subgroup_to_prototype("se-spaceship-floor", "space-intermediate-product-spaceship-structure", "02")
util.regroup.set_subgroup_to_prototype("se-spaceship-wall", "space-intermediate-product-spaceship-structure", "03")
util.regroup.set_subgroup_to_prototype("se-spaceship-gate", "space-intermediate-product-spaceship-structure", "04")
util.regroup.set_subgroup_to_prototype("se-spaceship-clamp", "space-intermediate-product-spaceship-structure", "05")
util.regroup.set_subgroup_to_prototype("se-spaceship-rocket-engine", "space-intermediate-product-spaceship-structure", "06")
util.regroup.set_subgroup_to_prototype("se-spaceship-rocket-booster-tank", "space-intermediate-product-spaceship-structure", "07")
util.regroup.set_subgroup_to_prototype("se-spaceship-ion-engine", "space-intermediate-product-spaceship-structure", "08")
util.regroup.set_subgroup_to_prototype("se-spaceship-ion-booster-tank", "space-intermediate-product-spaceship-structure", "09")
util.regroup.set_subgroup_to_prototype("se-spaceship-antimatter-engine", "space-intermediate-product-spaceship-structure", "10")
util.regroup.set_subgroup_to_prototype("se-spaceship-antimatter-booster-tank", "space-intermediate-product-spaceship-structure", "11")

-- space-intermediate-product-satellite
util.regroup.set_subgroup_to_prototype("satellite", "space-intermediate-product-satellite", "01")
util.regroup.set_subgroup_to_prototype("gps-satellite", "space-intermediate-product-satellite", "02")
util.regroup.set_subgroup_to_prototype("fu_space_probe_sputnik_recipe", "space-intermediate-product-satellite", "03")
util.regroup.set_subgroup_to_prototype("fu_space_probe_sputnik_item", "space-intermediate-product-satellite", "04")
util.regroup.set_subgroup_to_prototype("fu_space_probe_probe_recipe", "space-intermediate-product-satellite", "05")
util.regroup.set_subgroup_to_prototype("fu_space_probe_probe_item", "space-intermediate-product-satellite", "06")
util.regroup.set_subgroup_to_prototype("fu_space_probe_deep_probe_recipe", "space-intermediate-product-satellite", "07")
util.regroup.set_subgroup_to_prototype("fu_space_probe_deep_probe_item", "space-intermediate-product-satellite", "08")
...
util.regroup.set_subgroup_to_prototype("se-space-mirror", "space-intermediate-product-specialist-assembling", "03")
util.regroup.set_subgroup_to_prototype("se-space-mirror-alternate", "space-intermediate-product-specialist-assembling", "04")
util.regroup.set_subgroup_to_prototype("se-gammaray-detector", "space-intermediate-product-specialist-assembling", "05")
util.regroup.set_subgroup_to_prototype("se-material-testing-pack", "space-intermediate-product-specialist-assembling", "06")
util.regroup.set_subgroup_to_prototype("se-naquium-cube", "space-intermediate-product-specialist-assembling", "07")
util.regroup.set_subgroup_to_prototype("se-naquium-tessaract", "space-intermediate-product-specialist-assembling", "08")
util.regroup.set_subgroup_to_prototype("se-naquium-tessaract-alt", "space-intermediate-product-specialist-assembling", "09")
...
util.regroup.set_subgroup_to_prototype("se-arcosphere", "space-intermediate-product-arcosphere", "06")
util.regroup.set_subgroup_to_prototype("se-arcosphere-a", "space-intermediate-product-arcosphere", "07")
util.regroup.set_subgroup_to_prototype("se-arcosphere-b", "space-intermediate-product-arcosphere", "08")
util.regroup.set_subgroup_to_prototype("se-arcosphere-c", "space-intermediate-product-arcosphere", "09")
util.regroup.set_subgroup_to_prototype("se-arcosphere-d", "space-intermediate-product-arcosphere", "10")
util.regroup.set_subgroup_to_prototype("se-arcosphere-e", "space-intermediate-product-arcosphere", "11")
util.regroup.set_subgroup_to_prototype("se-arcosphere-f", "space-intermediate-product-arcosphere", "12")
util.regroup.set_subgroup_to_prototype("se-arcosphere-g", "space-intermediate-product-arcosphere", "13")
util.regroup.set_subgroup_to_prototype("se-arcosphere-h", "space-intermediate-product-arcosphere", "14")
...
util.regroup.set_subgroup_to_prototype("se-canister", "space-intermediate-product-canister-fill", "01")
util.regroup.set_subgroup_to_prototype("se-empty-lifesupport-canister", "space-intermediate-product-canister-fill", "02")
util.regroup.set_subgroup_to_prototype("se-used-lifesupport-canister", "space-intermediate-product-canister-fill", "03")
util.regroup.set_subgroup_to_prototype("se-empty-lifesupport-canister-cleaning", "space-intermediate-product-canister-fill", "04")
util.regroup.set_subgroup_to_prototype("se-empty-lifesupport-canister-cleaning-space", "space-intermediate-product-canister-fill", "05")
util.regroup.set_subgroup_to_prototype("se-lifesupport-canister", "space-intermediate-product-canister-fill", "06")
util.regroup.set_subgroup_to_prototype("se-lifesupport-canister-coal", "space-intermediate-product-canister-fill", "07")
util.regroup.set_subgroup_to_prototype("se-lifesupport-canister-fish", "space-intermediate-product-canister-fill", "08")
util.regroup.set_subgroup_to_prototype("se-lifesupport-canister-specimen", "space-intermediate-product-canister-fill", "09")
util.regroup.set_subgroup_to_prototype("se-magnetic-canister", "space-intermediate-product-canister-fill", "10")
util.regroup.set_subgroup_to_prototype("se-plasma-canister-empty", "space-intermediate-product-canister-fill", "11")
util.regroup.set_subgroup_to_prototype("se-plasma-canister", "space-intermediate-product-canister-fill", "12")
util.regroup.set_subgroup_to_prototype("se-ion-canister-empty", "space-intermediate-product-canister-fill", "13")
util.regroup.set_subgroup_to_prototype("se-ion-canister", "space-intermediate-product-canister-fill", "14")
util.regroup.set_subgroup_to_prototype("se-empty-antimatter-canister", "space-intermediate-product-canister-fill", "15")
util.regroup.set_subgroup_to_prototype("se-antimatter-canister", "space-intermediate-product-canister-fill", "16")
