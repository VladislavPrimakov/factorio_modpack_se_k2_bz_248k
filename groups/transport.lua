...
util.regroup.set_subgroup_to_prototype("recipe-space-locomotive", "transport-locomotives", "05")
util.regroup.set_subgroup_to_prototype("gr_magnet_train_pre_item", "transport-locomotives", "06")
util.regroup.set_subgroup_to_prototype("gr_magnet_train_pre_recipe", "transport-locomotives", "06")
util.regroup.set_subgroup_to_prototype("gr_magnet_train_item", "transport-locomotives", "07")
util.regroup.set_subgroup_to_prototype("gr_magnet_train_recipe", "transport-locomotives", "07")
...
util.regroup.set_subgroup_to_prototype("gr_magnet_wagon_pre_recipe", "transport-wagons", "03")
util.regroup.set_subgroup_to_prototype("gr_magnet_wagon_item", "transport-wagons", "04")
util.regroup.set_subgroup_to_prototype("gr_magnet_wagon_recipe", "transport-wagons", "04")
...
util.regroup.set_subgroup_to_prototype("recipe-space-fluid-wagon", "transport-fluid-wagons", "02")
util.regroup.set_subgroup_to_prototype("gr_magnet_tanker_pre_item", "transport-fluid-wagons", "03")
util.regroup.set_subgroup_to_prototype("gr_magnet_tanker_pre_recipe", "transport-fluid-wagons", "03")
util.regroup.set_subgroup_to_prototype("gr_magnet_tanker_item", "transport-fluid-wagons", "04")
util.regroup.set_subgroup_to_prototype("gr_magnet_tanker_recipe", "transport-fluid-wagons", "04")
...
util.regroup.set_subgroup_to_prototype("bi-rail-wood-to-concrete", "transport-rails", "02")
util.regroup.set_subgroup_to_prototype("bi-rail-wood-bridge", "transport-rails", "03")
util.regroup.set_subgroup_to_prototype("bi-rail-power", "transport-rails", "04")
util.regroup.set_subgroup_to_prototype("bi-power-to-rail-pole", "transport-rails", "05")
util.regroup.set_subgroup_to_prototype("se-space-rail", "transport-rails", "06")
